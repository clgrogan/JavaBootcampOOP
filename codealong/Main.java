    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                " Output for the 'car01' variable:"
                        + "\n   The " + car01.getMake() + "\s" + car01.getModel() + " is worth $" + car01.getPrice()
                        + " was built in " + car01.getYear() + ". It is "
                        + car01.getColor() + ".");
        System.out.println(
                " Output for the 'car02' variable:"
                        + "\n   The " + car02.getMake() + "\s" + car02.getModel() + " is worth $" + car02.getPrice()
        ...
        System.out.println(
                " Output for the 'car03' variable:"
                        + "\n   The " + car03.getMake() + "\s" + car03.getModel() + " is worth $" + car03.getPrice()
        ...
        System.out.println("Change the value of one part for one car with: \n\tcar03.parts[0] = \"22 inch Dubs\";");
        System.out.println();
